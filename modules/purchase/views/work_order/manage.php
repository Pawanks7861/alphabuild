         ...
         <div class="panel_s mbot10">
            <div class="panel-body">
               ...
               <div class="row">
                  ...
                  <div class="col-md-3 form-group">
                     <label for="wo_type"><?php echo _l('WO Type'); ?></label>
                     <select name="wo_type[]" id="wo_type" class="selectpicker" multiple="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('WO Type'); ?>">
                        <option value="1" selected><?php echo _l('From Client'); ?></option>
                        <option value="2"><?php echo _l('For Vendor'); ?></option>
                     </select>
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-12" id="small-table">
               <div class="panel_s">
                  <div class="panel-body">
                     ...
                     $custom_fields = get_custom_fields('wo_order', array('show_on_table' => 1));
...
<div class="modal fade" id="wo_order_expense" tabindex="-1" role="dialog">
   <div class="modal-dialog">
      <div class="modal-content">
         <?php echo form_open(admin_url('purchase/add_expense'), array('id' => 'wo_order-expense-form', 'class' => 'dropzone dropzone-manual')); ?>
