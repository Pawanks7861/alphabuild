         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-12 border-right project_file_area">
                  ...
                  <?php } ?>
                  <?php
                     $path = get_upload_path_by_type('inventory').'goods_receipt/'.$file->rel_id.'/'.$file->file_name;
                     $file_url = base_url('uploads/inventory/goods_receipt/' . $file->rel_id . '/' . $file->file_name);
                     if(is_image($path)){ ?>
